...
public class WhoAmIHandler implements Handler<RoutingContext> {
    ...
    public void handle(RoutingContext routingContext) {
        ...
        try {
            ...
            Collections
                ...
                .forEach(networkInterface -> {
                    ...
                    Collections.list(networkInterface.getInetAddresses()).forEach(inetAddress -> inetAddresses.add(inetAddress.toString()));
        ...
        routingContext
            ...
            .setTimer(
                latency,
                id -> response.putHeader("content-type", "application/json").setStatusCode(statusCode).end(content.encodePrettily())
            );
    }
}
